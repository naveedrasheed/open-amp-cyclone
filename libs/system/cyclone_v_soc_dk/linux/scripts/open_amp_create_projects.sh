...
if [ "$1" == "master" ]; then
	...
	cp $OPENAMP/libs/system/cyclone_v_soc_dk/linux/scripts/makefiles/mat_mul_demo/Makefile ./components/apps/mat_mul_demo/Makefile
	...
	#cyclone Remoteproc driver
	petalinux-create -t modules -n cyclone_remoteproc_driver --enable

	cp $OPENAMP/apps/samples/master/linux/kernelspace/cyclone_remoteproc_driver/cyclone_remoteproc_driver.c ./components/modules/cyclone_remoteproc_driver/cyclone_remoteproc_driver.c

	cp $OPENAMP/apps/samples/master/linux/kernelspace/cyclone_remoteproc_driver/remoteproc_internal.h ./components/modules/cyclone_remoteproc_driver/remoteproc_internal.h
	...
	cp $OPENAMP/apps/firmware/cyclone_v_soc_dk/baremetal/matrix_multiply/firmware ./components/apps/mat_mul_baremetal_fw/data/firmware

	cp $OPENAMP/libs/system/cyclone_v_soc_dk/linux/scripts/makefiles/mat_mul_baremetal_fw/Makefile ./components/apps/mat_mul_baremetal_fw/Makefile
	
	#Bare-metal Echo Test

	petalinux-create -t apps --template install -n echo_test_baremetal_fw --enable

	cp $OPENAMP/apps/firmware/cyclone_v_soc_dk/baremetal/echo_test/firmware ./components/apps/echo_test_baremetal_fw/data/firmware

	cp $OPENAMP/libs/system/cyclone_v_soc_dk/linux/scripts/makefiles/echo_test_baremetal_fw/Makefile ./components/apps/echo_test_baremetal_fw/Makefile
	
	#Baremetal RPC Demo

	petalinux-create -t apps --template install -n rpc_demo_baremetal_fw --enable
 
	cp $OPENAMP/apps/firmware/cyclone_v_soc_dk/baremetal/rpc_demo/firmware ./components/apps/rpc_demo_baremetal_fw/data/firmware

	cp $OPENAMP/libs/system/cyclone_v_soc_dk/linux/scripts/makefiles/rpc_demo_baremetal_fw/Makefile ./components/apps/rpc_demo_baremetal_fw/Makefile
	...
	#cyclone RPMSG Driver module

	petalinux-create -t modules -n cyclone_rpmsg_driver --enable

	cp $OPENAMP/apps/samples/master/linux/kernelspace/cyclone_rpmsg_driver/cyclone_rpmsg_driver.c ./components/modules/cyclone_rpmsg_driver/cyclone_rpmsg_driver.c
	cp $OPENAMP/apps/samples/master/linux/kernelspace/cyclone_rpmsg_driver/cyclone_rpmsg_internals.h ./components/modules/cyclone_rpmsg_driver/cyclone_rpmsg_internals.h
	...
	#DTS File
	cp $OPENAMP/libs/system/cyclone_v_soc_dk/linux/patches/linux/petalinux2013.10/system.dts ./subsystems/linux/hw-description/system.dts
